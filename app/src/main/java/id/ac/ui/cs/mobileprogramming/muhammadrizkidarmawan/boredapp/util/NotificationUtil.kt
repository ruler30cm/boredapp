...
import id.ac.ui.cs.mobileprogramming.muhammadrizkidarmawan.boredapp.AppConstants
import id.ac.ui.cs.mobileprogramming.muhammadrizkidarmawan.boredapp.MainActivity
import id.ac.ui.cs.mobileprogramming.muhammadrizkidarmawan.boredapp.R
import id.ac.ui.cs.mobileprogramming.muhammadrizkidarmawan.boredapp.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Bored App Timer"
        ...
        fun showTimerExpired(context: Context) {
            ...
            nManager.createNotificationChannel(CHANNEL_ID_TIMER, CHANNEL_ID_TIMER, true)
        ...
        fun showTimerPaused(context: Context) {
            ...
            val nManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            nManager.createNotificationChannel(CHANNEL_NAME_TIMER, CHANNEL_ID_TIMER, true)
            nManager.notify(TIMER_ID, nBuilder.build())
        }
        ...
        private fun getBasicNotificationBuilder(context: Context, channelIdTimer: String, b: Boolean): NotificationCompat.Builder {
            val notificationSound: Uri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
            val nBuilder = NotificationCompat.Builder(context, channelIdTimer)
                .setSmallIcon(R.drawable.ic_timer)
                .setAutoCancel(true)
                .setDefaults(0)
            if (b) nBuilder.setSound(notificationSound)
            return nBuilder
        }
